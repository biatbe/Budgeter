...
export default function Nav() {
  ...
  return (
    <header className="bg-gray-900 h-24">
      <nav className="mx-auto flex max-w-7xl h-full items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex ">
        ...
        <div className="hidden lg:flex lg:gap-x-12">
          {navigation.map((item) => (
            <a key={item.name} href={item.href} className="text-sm font-semibold leading-6 text-white p-4 hover:p-4 hover:rounded-xl hover:bg-black/50">
              {item.name}
            </a>
          ))}
        </div>
